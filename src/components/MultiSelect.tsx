...
const MultiSelect: React.FC<MultiSelectProps> = ({
  ...
  const getDisplayText = () => {
    ...
    return `${selectedValues.length} categorias selecionadas`;
  };
          ...
          >
            ...
            <div
              className={`w-4 h-4 border-2 rounded flex items-center justify-center ${
                isSelected ? "bg-[#2b9af3] border-[#2b9af3]" : "border-gray-300"
              }`}
            >
              {isSelected && (
                <svg
  ...
  return (
    <div ref={selectRef} className={`relative ${className}`}>
      ...
      <div className="relative">
        ...
        >
          <span
            className={`block truncate ${selectedValues.length > 0 ? "text-gray-900" : "text-gray-500"}`}
          >
            {getDisplayText()}
          </span>
