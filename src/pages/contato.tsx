...
const ContatoPage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      showToast(
        `Erro ao enviar mensagem: ${error instanceof Error ? error.message : "Tente novamente."}`,
        "error",
      );
    }
  };
  ...
  const handleWhatsAppClick = () => {
    const message = `Olá! Gostaria de entrar em contato sobre a plataforma de sublocação de espaços.`;
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            ...
            dúvidas, fazer sugestões ou obter suporte sobre nossa plataforma de
            sublocação de espaços.
          </p>
        </div>
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white rounded-2xl shadow-md p-6">
              ...
              <div className="space-y-2 text-gray-600">
                <p>
                  <span className="font-medium">Segunda a Sexta:</span> 8h às
                  18h
                </p>
                <p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <p className="text-gray-600 text-sm">
                  Todos os espaços são verificados e os proprietários são
                  validados para garantir sua segurança.
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600 text-sm">
                  Encontre e reserve espaços em minutos, com processo
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600 text-sm">
                  Nossa equipe está sempre disponível para ajudar e resolver
