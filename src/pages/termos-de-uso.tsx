          ...
          <div className="bg-white rounded-3xl shadow-md p-8 space-y-8">
            ...
            <section>
              ...
              <p className="text-gray-700 leading-relaxed">
                Ao acessar e utilizar a plataforma Sublease, você concorda em
                cumprir e estar vinculado aos presentes Termos de Uso. Se você
                não concordar com qualquer parte destes termos, não deve
                utilizar nossa plataforma.
              </p>
              <p className="text-gray-700 leading-relaxed mt-4">
                Estes termos constituem um acordo legal entre você e a Sublease,
                e regem o uso da plataforma de sublocação de espaços.
              </p>
            </section>
            ...
            <section>
              ...
              <div className="space-y-3">
                <p className="text-gray-700">
                  <strong>Plataforma:</strong> Refere-se ao site, aplicativo e
                  todos os serviços oferecidos pela Sublease.
                </p>
                <p className="text-gray-700">
                ...
                <p className="text-gray-700">
                  <strong>Proprietário:</strong> Usuário que oferece espaços
                  para sublocação.
                </p>
                <p className="text-gray-700">
                  <strong>Profissional:</strong> Usuário que busca espaços para
                  sublocação.
                </p>
                <p className="text-gray-700">
                  <strong>Sublocação:</strong> Contrato de locação temporária de
                  espaços físicos.
                </p>
              </div>
            </section>
            ...
            <section>
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                A Sublease é uma plataforma digital que conecta proprietários de
                espaços físicos com profissionais que necessitam de locais para
                atendimento ou operação. Nossa plataforma facilita:
              </p>
              <ul className="list-disc list-inside text-gray-700 space-y-2 ml-4">
                <li>Cadastro e listagem de espaços disponíveis</li>
                <li>Busca e filtros para encontrar espaços adequados</li>
            ...
            <section>
              ...
              <div className="space-y-4">
                <p className="text-gray-700 leading-relaxed">
                  ...
                  fornecendo informações verdadeiras, precisas e atualizadas.
                </p>
                <p className="text-gray-700 leading-relaxed">
                ...
                <ul className="list-disc list-inside text-gray-700 space-y-2 ml-4">
                  ...
                  <li>
                    Ser maior de 18 anos ou ter representação legal adequada
                  </li>
                </ul>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="space-y-4">
                <p className="text-gray-700 leading-relaxed">
                  A Sublease está comprometida com a proteção dos dados pessoais
                  conforme a Lei Geral de Proteção de Dados (Lei nº
                  13.709/2018).
                </p>
                ...
                <div className="bg-blue-50 p-4 rounded-lg">
                  ...
                  <ul className="list-disc list-inside text-blue-800 space-y-1">
                    ...
                    <li>Dados profissionais (categoria, CRM, etc.)</li>
            ...
            <section>
              ...
              <div className="space-y-4">
                <h3 className="text-lg font-semibold text-gray-800">
                  6.1. Proprietários de espaços
                </h3>
                <ul className="list-disc list-inside text-gray-700 space-y-2 ml-4">
                  <li>Fornecer informações verdadeiras sobre o espaço</li>
            ...
            <section>
              ...
              <div className="space-y-4">
                <p className="text-gray-700 leading-relaxed">
                  A Sublease atua como intermediária entre proprietários e
                  profissionais. Nossa responsabilidade limita-se a:
                </p>
                <ul className="list-disc list-inside text-gray-700 space-y-2 ml-4">
                ...
                <ul className="list-disc list-inside text-gray-700 space-y-2 ml-4">
                  ...
                  <li>
                    Danos materiais ou morais decorrentes do uso dos espaços
                  </li>
            ...
            <section>
              ...
              <p className="text-gray-700 leading-relaxed">
                ...
                design e funcionalidades, são de propriedade da Sublease e
                protegidos por leis de propriedade intelectual.
              </p>
              <p className="text-gray-700 leading-relaxed mt-4">
                Os usuários mantêm os direitos sobre o conteúdo que enviam, mas
                concedem à Sublease licença para utilizá-lo conforme necessário
            ...
            <section>
              ...
              <p className="text-gray-700 leading-relaxed">
                ...
                após sua publicação na plataforma.
              </p>
              <p className="text-gray-700 leading-relaxed mt-4">
            ...
            <section>
              ...
              <p className="text-gray-700 leading-relaxed">
                Podemos suspender ou encerrar sua conta a qualquer momento, com
                ou sem aviso prévio, em caso de violação destes Termos de Uso.
              </p>
              <p className="text-gray-700 leading-relaxed mt-4">
            ...
            <section>
              ...
              <div className="bg-gray-50 p-6 rounded-lg">
                <p className="text-gray-700 leading-relaxed mb-4">
                  Para dúvidas sobre estes Termos de Uso ou sobre a plataforma,
                  entre em contato:
                </p>
            ...
            <div className="border-t border-gray-200 pt-6 mt-8">
              <p className="text-sm text-gray-500 text-center">
                Estes Termos de Uso foram elaborados em conformidade com a
                legislação brasileira, incluindo a Lei Geral de Proteção de
                Dados (LGPD), o Código de Defesa do Consumidor e demais normas
                aplicáveis.
              </p>
            </div>
          </div>
