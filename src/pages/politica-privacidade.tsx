          ...
          <div className="bg-white rounded-3xl shadow-md p-8 space-y-8">
            ...
            <section>
              ...
              <p className="text-gray-700 leading-relaxed">
                A Sublease está comprometida com a proteção da privacidade e dos
            ...
            <section>
              ...
              <div className="space-y-4">
                <p className="text-gray-700 leading-relaxed">
                  Coletamos diferentes tipos de dados pessoais para fornecer
                  nossos serviços:
                </p>
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg">
                    ...
                    <ul className="text-sm text-gray-700 space-y-1">
                      <li>• Notificações sobre espaços</li>
                ...
                <div className="space-y-3">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700 text-sm">
                        Para envio de comunicações promocionais e marketing
                        direto.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700 text-sm">
                        Para prestação dos serviços da plataforma e cumprimento
                        dos termos de uso.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700 text-sm">
                        Para melhoria dos serviços, análise de dados e prevenção
                        de fraudes.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700 text-sm">
                        Para atender exigências legais e regulatórias
                        aplicáveis.
                      </p>
                    </div>
                  </div>
              ...
              <div className="space-y-4">
                ...
                <div className="bg-red-50 p-6 rounded-lg">
                  ...
                  <ul className="list-disc list-inside text-red-800 space-y-2">
                    <li>
                      Informações de contato para comunicação sobre espaços
                    </li>
                    <li>Dados básicos de identificação para verificação</li>
                    <li>
                      Informações profissionais relevantes para a sublocação
                    </li>
                  </ul>
                </div>
              ...
              <div className="space-y-4">
                ...
                <div className="bg-blue-50 p-6 rounded-lg mt-6">
                  ...
                  <p className="text-blue-800 mb-4">
                    Para exercer qualquer um dos direitos acima, entre em
                    contato conosco:
                  </p>
                ...
                <div className="bg-gray-50 p-6 rounded-lg">
                  <ul className="space-y-3 text-gray-700">
                    <li className="flex justify-between items-center">
                      <span>
                        <strong>Dados da conta:</strong> Enquanto sua conta
                        estiver ativa
                      </span>
                    ...
                    <li className="flex justify-between items-center">
                      <span>
                        <strong>Dados de navegação:</strong> Até 2 anos
                      </span>
                    ...
                    <li className="flex justify-between items-center">
                      <span>
                        <strong>Dados de comunicação:</strong> Até 3 anos
                      </span>
                    ...
                    <li className="flex justify-between items-center">
                      <span>
                        <strong>Dados para obrigações legais:</strong> Conforme
                        exigido por lei
                      </span>
            ...
            <section>
              ...
              <p className="text-gray-700 leading-relaxed">
                ...
                Quando houver alterações significativas, notificaremos você
                através de e-mail ou por meio de aviso na plataforma.
              </p>
              <p className="text-gray-700 leading-relaxed mt-4">
            ...
            <div className="border-t border-gray-200 pt-6 mt-8">
              <p className="text-sm text-gray-500 text-center">
                ...
                Geral de Proteção de Dados (LGPD - Lei nº 13.709/2018) e demais
                normas aplicáveis de proteção de dados pessoais no Brasil.
              </p>
            </div>
          </div>
        </div>
