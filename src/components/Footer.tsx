        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-300 mb-6 max-w-md">
              Conectamos quem tem espaços físicos com quem quer sublocar —
              salas, espaços, ambientes amplos e outros formatos, em qualquer
              ramo, com flexibilidade para quem anuncia e para quem busca.
            </p>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-6 text-sm">
              <Link
                ...
                className="text-gray-400 hover:text-[#2b9af3] transition-colors duration-200"
              >
